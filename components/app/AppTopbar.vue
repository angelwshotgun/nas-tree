      ...
      <div class="layout-topbar-menu hidden lg:block">
        <div class="layout-topbar-menu-content">
          ...
          <div class="relative">
            ...
            <div
              :class="[
                'absolute top-[3.25rem] right-0 w-48 p-4 bg-surface-0 dark:bg-surface-900 border border-surface rounded-border origin-top shadow-[0px_3px_5px_rgba(0,0,0,0.02),0px_0px_2px_rgba(0,0,0,0.05),0px_1px_4px_rgba(0,0,0,0.08)]',
                { hidden: !userVisible },
              ]"
            >
              <div
                class="flex flex-col gap-2 cursor-pointer hover:bg-surface-100 dark:hover:bg-surface-800 p-2 rounded-md"
                @click="signOut"
              >
